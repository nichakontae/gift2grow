...
import 'package:gift2grow/widgets/rank_widget/profile_for_top_three/profile_frame2nd.dart';
import 'package:gift2grow/widgets/rank_widget/show_level_quote.dart';

class SecondRank extends StatelessWidget {
  final int donations;
  const SecondRank({Key? key, required this.users, required this.donations})
      : super(key: key);
